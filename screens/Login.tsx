...
const Login = ({navigation}: {navigation: any}) => {
  ...
  const {currentVisitorName, SetcurrentVisitorName,
  currentVisitorId, SetcurrentVisitorId}=React.useContext(AppContext);
  ...
  return (
    <TouchableWithoutFeedback onPress={()=>Keyboard.dismiss()}>
      ...
      <Card style={{padding: 10, backgroundColor: '#FFF', margin: 10}}>
        ...
        <Button
          textColor="#fff"
          style={{borderRadius: 8, backgroundColor: '#FFBD11', marginTop: 5,display:isdisplay=="none"?"none":"flex"}}
          mode="elevated"
          loading={isloggingIn}
